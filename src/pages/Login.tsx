...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen overflow-hidden">
      {/* Left Brand Panel */}
      <div className="hidden lg:flex lg:w-[45%] relative overflow-hidden bg-gradient-to-br from-primary via-primary-hover to-accent p-12 flex-col justify-between">
        ...
        <div className="relative z-10 grid grid-cols-3 gap-4 animate-fade-in" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-4 hover:bg-white/15 transition-all">
            ...
            <div className="text-xs text-white/80">Loans Processed</div>
          </div>
          <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-4 hover:bg-white/15 transition-all">
            <div className="flex items-center gap-2 mb-2">
            ...
            <div className="text-xs text-white/80">Partner Universities</div>
          </div>
        </div>
      </div>
